...
# Color ranges for layers, defining RGBA values for gradients
color_ranges = {
...
if selected_gdfs:
    ...
    for gdf, layer in zip(selected_gdfs, selected_layers):
        ...
        # If historical data is available, show a time-series chart for each region
        # Assuming hypothetical time-series data as 'year' and 'value_column' for each region
